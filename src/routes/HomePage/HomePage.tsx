		...
		<div className="HomePage__body">
			<div className="HomePage__body-content">
				...
				<p>Осенью 2020 года любимая жена подарила мне новую замечательную клавиатуру, вот такую:
					<a href="https://kinesis-ergo.com/shop/advantage2/">https://kinesis-ergo.com/shop/advantage2/</a> и тут
				...
				<p>Чтобы привыкнуть к расположению клавиши, её нужно нажать много раз</p>
				...
				<p>Для тренировки урока, алгоритм случайным образом формирует текст тренировки учитывая всю предыдущую историю
					...
					добавлять символы/клавиши в текст так, чтобы вы нажимали их все примерно одинаково.</p>
				...
				<p>Когда все уроки "пройдены", вы "застрянете" на последнем уроке с текстами состоящими из всех символов
					...
					попадаться ошибочный символ/клавиша в генерируемых текстах.</p>
